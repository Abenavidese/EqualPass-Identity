  ...
  return (
    <div className="text-center space-y-6 py-12">
      ...
      <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-balance leading-relaxed">
        ZK-Scholar combina pruebas de conocimiento cero, autenticación biométrica y NFTs soulbound para
        proteger tu privacidad mientras verificas tu identidad estudiantil.
      </p>
